...
class Knifecycle {
  constructor() {
    ...
    const initInjectorProvider = provider(async ({
      $siloContext
    }) => ({
  ...
  register(initializer) {
    ...
    if (this._initializers.has(initializer[SPECIAL_PROPS.NAME])) {
      ...
      const initializedAsSingleton = this._singletonsServicesHandles.has(initializer[SPECIAL_PROPS.NAME]) && this._singletonsServicesDescriptors.has(initializer[SPECIAL_PROPS.NAME]) && !((_this$_singletonsServ = this._singletonsServicesDescriptors.get(initializer[SPECIAL_PROPS.NAME])) !== null && _this$_singletonsServ !== void 0 && _this$_singletonsServ.preloaded);
