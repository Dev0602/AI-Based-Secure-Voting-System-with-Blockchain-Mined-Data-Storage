...
It returns nothing and should be injected only for its
 side effects.
*/
var _default = (0, _knifecycle.singleton)((0, _knifecycle.provider)(initProcess, "process", ["NODE_ENV", "?PROCESS_NAME", "?SIGNALS", "?NODE_ENVS", "?log", "exit", "$instance", "$fatalError"]));
/**
...
async function initProcess({
  ...
  */
  ...
  if (!NODE_ENVS.includes(NODE_ENV)) {
    throw new _yerror.default('E_NODE_ENV', NODE_ENV);
  }
  ...
  */
  ...
  function catchUncaughtException(err) {
    ...
    log('error-stack', err.stack || // Catching anything that could be inside err
