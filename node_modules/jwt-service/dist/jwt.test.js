...
describe('jwt service', () => {
  ...
  describe('sign', () => {
    test('should work', async () => {
      ...
      const jwt = await (0, _jwt.default)({
        ENV: {
          JWT_SECRET: 'secret'
        },
        JWT: {
  ...
  describe('verify', () => {
    test('should work', async () => {
      ...
      const decoded = await jwt.verify('eyJhbGciOiJIUzI1NiJ9.' + 'eyJ1c2VySWQiOjIsIm9yZ2FuaXNhdGlvbklkIjozLCJpY' + 'XQiOjEzOTA2OTQ0MDAsImV4cCI6MTM5MDg2NzIwMCwibmJmIjoxMzkwNjk0NDAwfQ.' + 'DdWhIErffR-N-bTSsjr2tDOyinbMtYkL24IZxOVaB_0');
      expect({
        decoded,
        logs: log.mock.calls,
        times: time.mock.calls
    ...
    test('should fail after the validity duration', async () => {
      ...
      try {
        await jwt.verify('eyJhbGciOiJIUzI1NiJ9.' + 'eyJ1c2VySWQiOjIsIm9yZ2FuaXNhdGlvbklkIjozLCJpY' + 'XQiOjEzOTA2OTQ0MDAsImV4cCI6MTM5MDg2NzIwMCwibmJmIjoxMzkwNjk0NDAwfQ.' + 'DdWhIErffR-N-bTSsjr2tDOyinbMtYkL24IZxOVaB_0');
        throw new _yerror.default('E_UNEXPECTED_SUCCESS');
      } catch (err) {
        expect({
          errorCode: err.code,
