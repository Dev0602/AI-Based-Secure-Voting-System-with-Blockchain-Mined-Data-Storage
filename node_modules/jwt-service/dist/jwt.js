...
exports.default = exports.DEFAULT_JWT_SECRET_ENV_NAME = void 0;
...
const DEFAULT_JWT_SECRET_ENV_NAME = 'JWT_SECRET';
exports.DEFAULT_JWT_SECRET_ENV_NAME = DEFAULT_JWT_SECRET_ENV_NAME;
...
Finally, it deal with promises which are more convenient than the
 original API.
*/
var _default = (0, _knifecycle.service)(initJWT, 'jwt', ['?JWT_SECRET_ENV_NAME', '?ENV', 'JWT', '?log', '?time']);
/**
...
async function initJWT({
  ...
  const secretName = JWT_SECRET_ENV_NAME || JWT.secretEnvName || DEFAULT_JWT_SECRET_ENV_NAME;
  const jwtSecret = ENV === null || ENV === void 0 ? void 0 : ENV[secretName];
  ...
  async function sign(payload, algorithm = JWT.algorithms[0]) {
    ...
    const token = await new Promise((resolve, reject) => {
      _jsonwebtoken.default.sign(JSON.stringify(_objectSpread(_objectSpread({}, payload), {}, {
